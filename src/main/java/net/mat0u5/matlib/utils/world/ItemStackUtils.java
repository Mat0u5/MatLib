...
public class ItemStackUtils {
    ...
    *///?} else {
    ...
    /**
     * Removes the Custom Data item component.
     */
    public static void removeCustomComponentEntry(ItemStack itemStack, String componentEntry) {
        CustomData nbt = itemStack.getComponents().get(DataComponents.CUSTOM_DATA);
        if (nbt == null) return;
    ...
    /**
     * Spawns an item into the world which only a specific player can pick up.
     */
    ...
    /**
     * Creates an enchanted book from a given {@code ResourceKey<Enchantment>} and {@code level}
     */
